...
import com.mycompany.angularsandbox.config.KafkaSseConsumer;
import com.mycompany.angularsandbox.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/angular-sandbox-application-kafka")
public class AngularSandboxApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AngularSandboxApplicationKafkaResource.class);
    ...
    public AngularSandboxApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
